...
#include "compiler/airc-codegen/lib/AIR/AIRDialect.cpp.inc"

// Include type definitions (with MLIR_DEFINE_EXPLICIT_TYPE_ID and parse/print methods)
#define GET_TYPEDEF_CLASSES
#include "compiler/airc-codegen/lib/AIR/AIRTypes.cpp.inc"
